...
public class Student extends User {
    public Student(String name, String surname, String email, String password, boolean mailNotification, boolean appNotification, boolean isAuthority) {
        super(name, surname, email, password, mailNotification, appNotification, isAuthority);
    }
